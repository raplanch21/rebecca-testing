<template>
  <div class="insights-home">
    ...
    <AgentModeModal 
      ...
      @close="$emit('close-global-agent-mode')"
    />
  </div>
</template>
...
import PendoButton from '../components/pendo/PendoButton.vue'
import PendoIcon from '../components/pendo/PendoIcon.vue'
import PendoAppTag from '../components/pendo/PendoAppTag.vue'
import PendoFilterTag from '../components/pendo/PendoFilterTag.vue'
import InsightCard from '../components/InsightCard.vue'
import GroupedInsightCard from '../components/GroupedInsightCard.vue'
...
/* Default: let cards stretch in grid rows for equal height */
