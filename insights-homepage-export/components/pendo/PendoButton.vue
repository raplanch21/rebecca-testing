...
const props = defineProps({
  /** Button type: primary, secondary, tertiary, tertiary-link, destructive */
  type: {
    type: String,
    default: 'primary',
    validator: (v) => ['primary', 'secondary', 'tertiary', 'tertiary-link', 'destructive'].includes(v)
  },
...
.pendo-button--secondary {
  ...
  border: 1px solid #128297; /* teal-70 */
}
...
.pendo-button--secondary:active:not(:disabled) {
  background-color: #E0FCFA; /* teal-10 */
  border-color: #005164; /* teal-90 */
  color: #005164; /* teal-90 */
}
...
/* ========================================
   TERTIARY - Ghost gray text, no bg
   ======================================== */
