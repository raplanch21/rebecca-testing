  ...
  <div class="insight-card">
    ...
    <div class="insight-card__header">
      ...
      <div class="insight-card__header-actions">
        <!-- Agent Mode Button (optional, shown in header) -->
        <button 
          v-if="showAgentInHeader"
          class="insight-card__header-agent-btn" 
          type="button"
          @click="openAgentMode"
        >
      ...
      <div class="insight-card__footer">
        ...
        <div v-if="isExpanded" class="insight-card__expanded-content">
          ...
          <button class="insight-card__expand-btn" @click="toggleExpanded">
            <span class="insight-card__label">{{ collapseLabelText }}</span>
        ...
        <!-- Button Row (expand) - only show when collapsed -->
        <button v-if="!isExpanded" class="insight-card__expand-btn" @click="toggleExpanded">
          <span class="insight-card__label">{{ expandLabel }}</span>
...
const props = defineProps({
  ...
  /** Label for collapse button (when expanded) - defaults to expandLabel if not provided */
  collapseLabel: {
    type: String,
    default: ''
  },
  /** Show Agent mode button in header */
  showAgentInHeader: {
    type: Boolean,
    default: false
  }
...
// Get the appropriate collapse label
const collapseLabelText = computed(() => {
  return props.collapseLabel || props.expandLabel
})
</script>
...
.insight-card__header-actions {
  display: flex;
  align-items: center;
  gap: 8px;
}

.insight-card__header-agent-btn {
  display: inline-flex;
  align-items: center;
  gap: 4px;
  height: 26px;
...
.insight-card__header-agent-btn:hover {
  background-color: rgba(172, 217, 228, 0.1);
}

.insight-card__header-agent-btn:hover span {
  color: var(--teal-80, #01697E);
}

.insight-card__header-agent-btn :deep(svg) {
  color: var(--teal-80, #01697E);
  flex-shrink: 0;
  width: 13.34px;
  height: 13.34px;
